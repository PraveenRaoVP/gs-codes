...
public int scoresAverage(int[] scores) {
    int avg1 = returnAverage(scores,0,scores.length/2);
    int avg2 = returnAverage(scores, scores.length/2, scores.length);
    return  avg1 > avg2 ? avg1 : avg2; 
  }
  
  public int returnAverage(int[] scores, int start, int end) {
    int sum = 0;
